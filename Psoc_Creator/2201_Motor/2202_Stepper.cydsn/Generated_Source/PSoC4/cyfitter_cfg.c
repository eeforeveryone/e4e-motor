...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x000000BBu);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00000099u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x0800EE00u);

		/* TCPWM_CNT1 Starting address: CYDEV_TCPWM_CNT1_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00030020u);

	}

	/* Perform second pass device configuration. These items must be configured in specific order after the regular configuration is done. */
	/* IOPINS0_0 Starting address: CYDEV_GPIO_PRT0_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT0_BASE), 0x00000048u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00000409u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x000000C0u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000092u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x004021B1u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x00000002u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000020u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00D80180u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x00000020u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x000000C1u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x005B6D82u);

	/* IOPINS0_4 Starting address: CYDEV_GPIO_PRT4_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x00000004u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x00000C00u);

// ======================================================================
// 2202_Stepper.v generated from TopDesign.cysch
// 03/21/2022 at 09:23
...
module CapSense_P4_v7_0_2 ;
    ...
    cy_psoc4_csd2_v1_30 CSD (
        ...
        .tx(Net_121),
        .vref_ext(Net_150));
    defparam CSD.adc_channel_count = 4;
	...
	wire [3:0] tmpOE__AdcInput_net;
	wire [3:0] tmpFB_3__AdcInput_net;
	wire [3:0] tmpIO_3__AdcInput_net;
	...
	cy_psoc3_pins_v1_10
		...
		AdcInput
		 (.oe(tmpOE__AdcInput_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__AdcInput_net[3:0]}),
		  .analog({Net_132[3:0]}),
		  .io({tmpIO_3__AdcInput_net[3:0]}),
	...
	assign tmpOE__AdcInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3cb2d5f0-6c8d-4848-83b5-f2a00af36216"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CW_CCW_net;
	wire [0:0] tmpFB_0__CW_CCW_net;
	wire [0:0] tmpIO_0__CW_CCW_net;
	wire [0:0] tmpINTERRUPT_0__CW_CCW_net;
	electrical [0:0] tmpSIOVREF__CW_CCW_net;

	cy_psoc3_pins_v1_10
		#(.id("287797bb-8aa3-442b-ac02-0f3126cdec0b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CW_CCW
		 (.oe(tmpOE__CW_CCW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CW_CCW_net[0:0]}),
		  .io({tmpIO_0__CW_CCW_net[0:0]}),
		  .siovref(tmpSIOVREF__CW_CCW_net),
		  .interrupt({tmpINTERRUPT_0__CW_CCW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CW_CCW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MODE0_net;
	wire [0:0] tmpFB_0__MODE0_net;
	wire [0:0] tmpIO_0__MODE0_net;
	wire [0:0] tmpINTERRUPT_0__MODE0_net;
	electrical [0:0] tmpSIOVREF__MODE0_net;

	cy_psoc3_pins_v1_10
		#(.id("cd138430-06dc-42f8-bc3b-30e3cdd30102"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MODE0
		 (.oe(tmpOE__MODE0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MODE0_net[0:0]}),
		  .io({tmpIO_0__MODE0_net[0:0]}),
		  .siovref(tmpSIOVREF__MODE0_net),
		  .interrupt({tmpINTERRUPT_0__MODE0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MODE0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ffcba7b3-46fa-47ef-bbeb-f02b33014a2e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__N_MOTrst_net;
	wire [0:0] tmpFB_0__N_MOTrst_net;
	wire [0:0] tmpIO_0__N_MOTrst_net;
	wire [0:0] tmpINTERRUPT_0__N_MOTrst_net;
	electrical [0:0] tmpSIOVREF__N_MOTrst_net;

	cy_psoc3_pins_v1_10
		#(.id("210fe958-a232-463c-b607-605b789fff08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		N_MOTrst
		 (.oe(tmpOE__N_MOTrst_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__N_MOTrst_net[0:0]}),
		  .io({tmpIO_0__N_MOTrst_net[0:0]}),
		  .siovref(tmpSIOVREF__N_MOTrst_net),
		  .interrupt({tmpINTERRUPT_0__N_MOTrst_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__N_MOTrst_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d98c6ab8-018f-4c8e-86ac-0babb5aaaaff"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8673c799-f496-4104-92ea-4944a3c2eb08"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a29f299-a608-4812-b397-f8dd7e3ca38c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("16bfa487-a5e8-443d-a342-9d3ab9f4234a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("13604e5e-6655-44c8-a13e-29b8027ca794"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),

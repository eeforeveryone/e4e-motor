// ======================================================================
// 2201_Motor.v generated from TopDesign.cysch
// 03/21/2022 at 07:15
...
module CapSense_P4_v7_0_4 ;
    ...
    cy_psoc4_csd2_v1_30 CSD (
        ...
        .tx(Net_121),
        .vref_ext(Net_150));
    defparam CSD.adc_channel_count = 3;
    defparam CSD.dedicated_io_count = 2;
    defparam CSD.ganged_csx = 0;
    defparam CSD.is_capsense = 0;
	...
	wire [2:0] tmpOE__AdcInput_net;
	wire [2:0] tmpFB_2__AdcInput_net;
	wire [2:0] tmpIO_2__AdcInput_net;
	wire [0:0] tmpINTERRUPT_0__AdcInput_net;
	electrical [0:0] tmpSIOVREF__AdcInput_net;

	cy_psoc3_pins_v1_10
		#(.id("a1220c5b-477b-4fb1-a608-15c2e43ad56f/30182841-2754-4aee-9532-9ff02059dfef"),
		...
		AdcInput
		 (.oe(tmpOE__AdcInput_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__AdcInput_net[2:0]}),
		  .analog({Net_132[2:0]}),
		  .io({tmpIO_2__AdcInput_net[2:0]}),
	...
	assign tmpOE__AdcInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

    cy_analog_noconnect_v1_0 cy_analog_noconnect_1 (
        .noconnect(Net_150));

	// cy_analog_virtualmux_2 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_2_connect(Net_352, Net_324);
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=11999, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=SYSTCK_TIMER, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SYSTCK_TIMER, CY_INSTANCE_SHORT_NAME=SYSTCK_TIMER, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=SYSTCK_TIMER, )
...
module top ;
	...
	wire [0:0] tmpOE__MOT_IN1_net;
	wire [0:0] tmpFB_0__MOT_IN1_net;
	wire [0:0] tmpIO_0__MOT_IN1_net;
	wire [0:0] tmpINTERRUPT_0__MOT_IN1_net;
	electrical [0:0] tmpSIOVREF__MOT_IN1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		MOT_IN1
		 (.oe(tmpOE__MOT_IN1_net),
		  .y({Net_1166}),
		  .fb({tmpFB_0__MOT_IN1_net[0:0]}),
		  .io({tmpIO_0__MOT_IN1_net[0:0]}),
		  .siovref(tmpSIOVREF__MOT_IN1_net),
		  .interrupt({tmpINTERRUPT_0__MOT_IN1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOT_IN1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__encA_net;
	wire [0:0] tmpIO_0__encA_net;
	wire [0:0] tmpINTERRUPT_0__encA_net;
	electrical [0:0] tmpSIOVREF__encA_net;
	...
	cy_psoc3_pins_v1_10
		...
		encA
		 (.oe(tmpOE__encA_net),
		  .y({1'b0}),
		  .fb({Net_8582}),
		  .io({tmpIO_0__encA_net[0:0]}),
		  .siovref(tmpSIOVREF__encA_net),
		  .interrupt({tmpINTERRUPT_0__encA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__encB_net;
	wire [0:0] tmpIO_0__encB_net;
	wire [0:0] tmpINTERRUPT_0__encB_net;
	electrical [0:0] tmpSIOVREF__encB_net;

	cy_psoc3_pins_v1_10
		#(.id("d8ea4cd5-4af1-48d2-b698-ad5a11e903a3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		encB
		 (.oe(tmpOE__encB_net),
		  .y({1'b0}),
		  .fb({Net_8588}),
		  .io({tmpIO_0__encB_net[0:0]}),
		  .siovref(tmpSIOVREF__encB_net),
		  .interrupt({tmpINTERRUPT_0__encB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("97a856e2-5346-4e7b-8adf-411e2e698bc1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_ACT_net;
	wire [0:0] tmpFB_0__LED_ACT_net;
	wire [0:0] tmpIO_0__LED_ACT_net;
	wire [0:0] tmpINTERRUPT_0__LED_ACT_net;
	electrical [0:0] tmpSIOVREF__LED_ACT_net;

	cy_psoc3_pins_v1_10
		#(.id("1465ca08-50b5-4152-88a3-7d36ff4e3117"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_ACT
		 (.oe(tmpOE__LED_ACT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_ACT_net[0:0]}),
		  .io({tmpIO_0__LED_ACT_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_ACT_net),
		  .interrupt({tmpINTERRUPT_0__LED_ACT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_ACT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOT_IN2_net;
	wire [0:0] tmpFB_0__MOT_IN2_net;
	wire [0:0] tmpIO_0__MOT_IN2_net;
	wire [0:0] tmpINTERRUPT_0__MOT_IN2_net;
	electrical [0:0] tmpSIOVREF__MOT_IN2_net;

	cy_psoc3_pins_v1_10
		#(.id("d655c654-f13c-4422-a990-280839e331c4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MOT_IN2
		 (.oe(tmpOE__MOT_IN2_net),
		  .y({Net_8578}),
		  .fb({tmpFB_0__MOT_IN2_net[0:0]}),
		  .io({tmpIO_0__MOT_IN2_net[0:0]}),
		  .siovref(tmpSIOVREF__MOT_IN2_net),
		  .interrupt({tmpINTERRUPT_0__MOT_IN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOT_IN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
